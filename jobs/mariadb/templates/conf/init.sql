...
INSERT INTO `cp`.`admin_token`(`token_name`, `token_value`) VALUES ('caas_admin', '<%= link("caas-jenkins-broker-link").p("caas.k8s_auth_bearer") %>');
INSERT INTO `broker`.`admin_token`(`token_name`, `token_value`) VALUES ('caas_admin', '<%= link("caas-jenkins-broker-link").p("caas.k8s_auth_bearer") %>');
...
INSERT INTO `caas`.`admin_token`(`token_name`, `token_value`) VALUES ('caas_admin', '<%= link("caas-jenkins-broker-link").p("caas.k8s_auth_bearer") %>');
